...
import {View, Text, ScrollView, ImageBackground, TextInput, TouchableOpacity,Dimensions  } from 'react-native';
    ...
    return (
        <SafeAreaView style={{flex:1, backgroundColor:'#fff'}}>
            ...
            >
                ...
                <TextInput placeholder="Search"  style={{marginRight:5, marginTop: 1}}/>
                </View>
